...
import Resp, { LoginData } from './interfaces';
...
export default class Apis {
   ...
   */
  getRoomInfo = (roomId: number, dataFunc: (data: any) => {}): Promise<Resp<any>> => {
  ...
  followAnchor = (explicit_id: number): Promise<Resp<any>> => {
    return new Promise(((resolve, reject) => {
        const urlPrefix = ' https://now.qq.com/cgi-bin/now/web/anchor/follow_anchor?bkn={bkn}';
        const req = net.request({
